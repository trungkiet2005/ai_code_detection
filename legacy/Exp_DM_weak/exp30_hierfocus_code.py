"""
[EXP30] HierFocusCode (DM)

Wrapper over EXP27 DeTeCtiveCode:
- stronger hierarchical family constraints
- balanced SupCon + standard kNN blend
"""
...
def apply_variant(cfg: base.Config) -> base.Config:
    cfg.lambda_hier = 0.55
    cfg.hier_margin = 0.40
    cfg.lambda_supcon = 0.12
    cfg.use_rag = True
    cfg.rag_k = 32
    cfg.rag_alpha = 0.25
    cfg.save_dir = "./exp30_hierfocus_checkpoints"
    return cfg
