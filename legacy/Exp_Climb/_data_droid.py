...
from legacy.Exp_Climb._common import PreflightError, SpectralConfig, apply_hardware_profile, logger, set_seed
from legacy.Exp_Climb._model import SpectralCode
...
def _make_droid_loaders(train_data, val_data, test_data, tokenizer, exp_cfg: SpectralConfig):
    ...
    from legacy.Exp_Climb._model import AICDDataset
