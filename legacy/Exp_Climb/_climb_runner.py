...
from legacy.Exp_Climb._common import PreflightError, get_gpu_name, logger
from legacy.Exp_Climb._data_codet import (
    CoDETM4Config,
    FULL_RUN_PLAN,
...
from legacy.Exp_Climb._data_droid import DroidConfig, preflight_droid, run_droid_suite
from legacy.Exp_Climb._features import ast_parser_available
...
def emit_combined_paper_table(
    ...
    try:
        from legacy.Exp_Climb._paper_table import emit_paper_table
    except ImportError:
...
def preflight_full_climb(
    ...
    if need_codet:
        ...
        from legacy.Exp_Climb._common import apply_hardware_profile, SpectralConfig
...
def run_full_climb(
    ...
    try:
        if run_mode == "full":
            ...
            try:
                import legacy.Exp_Climb._data_codet as _dc_mod
                import legacy.Exp_Climb._data_droid as _dd_mod
                ...
                from legacy.Exp_Climb._data_droid import run_droid_iid as _run_droid_iid
