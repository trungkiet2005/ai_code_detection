"""
exp_fs_baseline_graphcodebert.py -- ONE-FILE self-contained baseline reimplementation for Kaggle T4.

Method: FS-Baseline-GraphCodeBERT
...
Output: /kaggle/working/results/exp_fs_baseline_graphcodebert_<label>_seed<S>.json
"""
...
METHODS = {
    "baseline":       ('FS-Baseline-GraphCodeBERT',   'exp_fs_baseline_graphcodebert',   "ce",     False),
