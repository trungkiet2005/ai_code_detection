"""
exp_fs_baseline_codebert.py -- ONE-FILE self-contained baseline reimplementation for Kaggle T4.

Method: FS-Baseline-CodeBERT
Encoder: microsoft/codebert-base
CodeBERT (Feng et al. 2020) -- 64.80 full-data Macro-F1 in CoDET-M4 paper Table 7
Paper full-data baseline: **64.80 Macro-F1** (Author IID, CoDET-M4).
...
Output: /kaggle/working/results/exp_fs_baseline_codebert_<label>_seed<S>.json
"""
...
METHODS = {
    "baseline":       ('FS-Baseline-CodeBERT',   'exp_fs_baseline_codebert',   "ce",     False),
