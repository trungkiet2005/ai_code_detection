"""
exp_fs_inline_baseline.py -- ONE-FILE self-contained few-shot suite for Kaggle T4.

Method: FS-Baseline-CE (ModernBERT + CE only (floor))
...
Output: /kaggle/working/results/exp_fs_inline_baseline_<label>_seed<S>.json
        (or ./results/... locally)
"""
