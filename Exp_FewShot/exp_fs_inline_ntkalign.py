"""
exp_fs_inline_ntkalign.py -- ONE-FILE self-contained few-shot suite for Kaggle T4.

Method: FS-NTKAlign (CE + NTK target-kernel alignment)
...
Output: /kaggle/working/results/exp_fs_inline_ntkalign_<label>_seed<S>.json
        (or ./results/... locally)
"""
...
logger = logging.getLogger('exp_fs_inline_ntkalign')
