"""
exp_fs_baseline_unixcoder.py -- ONE-FILE self-contained baseline reimplementation for Kaggle T4.

Method: FS-Baseline-UniXcoder
Encoder: microsoft/unixcoder-base
UniXcoder (Guo et al. ACL'22) -- strongest paper baseline at 66.33 full-data Macro-F1
Paper full-data baseline: **66.33 Macro-F1** (Author IID, CoDET-M4).
...
Output: /kaggle/working/results/exp_fs_baseline_unixcoder_<label>_seed<S>.json
"""
...
METHODS = {
    "baseline":       ('FS-Baseline-UniXcoder',   'exp_fs_baseline_unixcoder',   "ce",     False),
