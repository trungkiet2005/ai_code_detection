"""
exp_fs_inline_focal.py -- ONE-FILE self-contained inline for Kaggle T4.

Method: FS-Focal (Focal loss (Lin et al. ICCV'17) -- target class-3 (llama3.1) collapse F1=0.002)
...
Output: /kaggle/working/results/exp_fs_inline_focal_<label>_seed<S>.json
"""
...
logger = logging.getLogger('exp_fs_inline_focal')
...
METHODS = {
    ...
    'focal'         : ('FS-Focal', 'exp_fs_inline_focal', 'focal', False),
