...
**Table format:** one row per method. Regime cells use `Test/Val/Gap` = test Macro-F1 / val Macro-F1 / val-test gap. `Best` is the highest test Macro-F1 for that method across all available regimes. `d vs paper` uses UniXcoder full-data **0.6633**.

**Coverage:** **113** result JSON files ingested -> **93** `(method, regime)` cells; **24** paper-usable methods after excluding the incomplete `method=Test` stub (`exp_fs_99_K128_seed42.json`). Zip archives and non-result `__huggingface_repos__*.json` files have been cleaned from `results/`.

| Rank | Trk | Method | Best | Best Regime | d vs paper | 20% T/V/G | 10% T/V/G | 5% T/V/G | 1% T/V/G | K128 T/V/G | K32 T/V/G | Cells | JSON count |
| :-: | :-: | :-- | -: | :-: | -: | :-- | :-- | :-- | :-- | :-- | :-- | -: | -: |
| 1 | test | FS-Baseline-UniXcoder | 0.7028 | `frac=0.2000` | +0.0395 | 0.7028/0.7242/+0.0213 | 0.6844/0.7300/+0.0456 | 0.6512/0.6912/+0.0400 | 0.5744/0.5839/+0.0095 | 0.3727/0.3968/+0.0241 | - | 5 | 6 |
| 2 | test | FS-Hier-NTK | 0.6709 | `frac=0.0500` | +0.0076 | - | - | 0.6709/0.7041/+0.0332 | 0.5608/0.5708/+0.0099 | 0.2775/0.3139/+0.0364 | - | 3 | 6 |
| 3 | novel | FS-ConformalMondrian | 0.6701 | `frac=0.0500` | +0.0068 | - | - | 0.6701/0.7081/+0.0380 | 0.5750/0.5944/+0.0194 | 0.3338/0.3244/-0.0094 | 0.1897/0.2225/+0.0328 | 4 | 5 |
| 4 | test | FS-HierTree | 0.6682 | `frac=0.0500` | +0.0049 | - | - | 0.6682/0.6824/+0.0142 | 0.5654/0.5971/+0.0317 | 0.3492/0.3089/-0.0403 | - | 3 | 6 |
| 5 | novel | FS-SlicedWassersteinClass | 0.6674 | `frac=0.0500` | +0.0041 | - | - | 0.6674/0.7027/+0.0353 | 0.5729/0.5884/+0.0155 | 0.3453/0.3354/-0.0100 | 0.1499/0.1923/+0.0424 | 4 | 5 |
| 6 | novel | FS-FrontDoor-StyleMediator | 0.6661 | `frac=0.0500` | +0.0028 | - | - | 0.6661/0.7103/+0.0442 | 0.5658/0.5963/+0.0305 | 0.3373/0.3052/-0.0321 | 0.1484/0.2260/+0.0776 | 4 | 4 |
| 7 | test | FS-NTKAlign | 0.6661 | `frac=0.0500` | +0.0028 | - | - | 0.6661/0.7017/+0.0356 | 0.5697/0.5614/-0.0083 | 0.2929/0.3348/+0.0419 | 0.1831/0.2280/+0.0449 | 4 | 5 |
| 8 | novel | FS-VIB | 0.6659 | `frac=0.0500` | +0.0026 | - | - | 0.6659/0.7006/+0.0347 | 0.5628/0.5764/+0.0135 | 0.3510/0.3487/-0.0023 | 0.1803/0.2229/+0.0427 | 4 | 4 |
| 9 | novel | FS-VarianceInvariantSource | 0.6654 | `frac=0.0500` | +0.0021 | - | - | 0.6654/0.6899/+0.0246 | 0.5701/0.5766/+0.0065 | 0.2848/0.3118/+0.0270 | 0.1635/0.2181/+0.0546 | 4 | 4 |
| 10 | novel | FS-TENT-TTA | 0.6651 | `frac=0.0500` | +0.0018 | - | - | 0.6651/0.6857/+0.0207 | 0.5596/0.5631/+0.0034 | 0.3176/0.3025/-0.0151 | 0.1409/0.2089/+0.0680 | 4 | 4 |
| 11 | test | FS-Focal | 0.6616 | `frac=0.0500` | -0.0017 | - | - | 0.6616/0.6975/+0.0359 | 0.5565/0.5765/+0.0200 | 0.3749/0.3378/-0.0371 | - | 3 | 9 |
| 12 | novel | FS-EnergyOOD | 0.6551 | `frac=0.0500` | -0.0082 | - | - | 0.6551/0.6753/+0.0203 | 0.5178/0.5240/+0.0062 | 0.2404/0.2946/+0.0543 | 0.1069/0.1433/+0.0364 | 4 | 4 |
| 13 | novel | FS-DataMapsCurriculum | 0.6481 | `frac=0.0500` | -0.0152 | - | - | 0.6481/0.6849/+0.0368 | 0.5669/0.6070/+0.0401 | 0.3397/0.3119/-0.0278 | 0.1812/0.2226/+0.0414 | 4 | 4 |
| 14 | novel | FS-TreeWassersteinGenealogy | 0.6467 | `frac=0.0500` | -0.0166 | - | - | 0.6467/0.6702/+0.0235 | 0.5425/0.5460/+0.0035 | 0.3165/0.2834/-0.0331 | 0.1907/0.2039/+0.0132 | 4 | 4 |
| 15 | novel | FS-IRM | 0.6430 | `frac=0.0500` | -0.0203 | - | - | 0.6430/0.6672/+0.0242 | 0.4693/0.4831/+0.0138 | 0.3160/0.3163/+0.0003 | 0.1186/0.1625/+0.0439 | 4 | 4 |
| 16 | novel | FS-PACBayes-SampleFloor | 0.6341 | `frac=0.0500` | -0.0292 | - | - | 0.6341/0.6835/+0.0494 | 0.5574/0.5848/+0.0274 | 0.2930/0.3221/+0.0292 | 0.1753/0.2388/+0.0635 | 4 | 4 |
| 17 | novel | FS-SRD-SiblingResidual | 0.6202 | `frac=0.0500` | -0.0431 | - | - | 0.6202/0.6742/+0.0540 | 0.5417/0.5784/+0.0367 | 0.3130/0.3018/-0.0113 | 0.1894/0.1949/+0.0055 | 4 | 8 |
| 18 | test | FS-Baseline-CodeBERT | 0.5977 | `frac=0.0500` | -0.0656 | - | - | 0.5977/0.6469/+0.0492 | 0.5007/0.5831/+0.0824 | 0.2651/0.2946/+0.0295 | - | 3 | 3 |
| 19 | test | FS-Baseline-GraphCodeBERT | 0.5951 | `frac=0.0500` | -0.0682 | - | - | 0.5951/0.6856/+0.0905 | 0.5014/0.5760/+0.0746 | 0.2191/0.3059/+0.0868 | - | 3 | 3 |
| 20 | novel | FS-SpectralEigengap | 0.5645 | `frac=0.0500` | -0.0988 | - | - | 0.5645/0.6119/+0.0474 | 0.4822/0.5039/+0.0217 | 0.2331/0.2181/-0.0149 | 0.1522/0.1676/+0.0154 | 4 | 4 |
| 21 | test | FS-NTKAlign-Frozen | 0.4608 | `frac=0.0500` | -0.2025 | - | - | 0.4608/0.4947/+0.0339 | 0.4037/0.4220/+0.0183 | 0.1479/0.2465/+0.0986 | 0.1348/0.1338/-0.0010 | 4 | 4 |
| 22 | test | FS-SupCon-Frozen | 0.4607 | `frac=0.0500` | -0.2026 | - | - | 0.4607/0.4947/+0.0340 | 0.4038/0.4221/+0.0183 | 0.1493/0.2522/+0.1029 | 0.1347/0.1338/-0.0009 | 4 | 4 |
| 23 | novel | FS-Prototypical | 0.1904 | `frac=0.0500` | -0.4729 | - | - | 0.1904/0.2274/+0.0370 | 0.1224/0.1537/+0.0312 | 0.0683/0.0741/+0.0058 | 0.0339/0.0476/+0.0137 | 4 | 4 |
| 24 | novel | FS-ETF-FrozenSimplex | 0.0859 | `frac=0.0500` | -0.5774 | - | - | 0.0859/0.1020/+0.0161 | 0.0491/0.0623/+0.0132 | 0.0339/0.0476/+0.0137 | 0.0339/0.0476/+0.0137 | 4 | 4 |

**Reading:** With the newly-unzipped results, `FS-Baseline-UniXcoder` at **20%** is the overall FewShot-table top (**0.7028**) and its **10%** run reaches **0.6844**. For the paper-facing low-budget **5%** slice, `FS-Hier-NTK` is still the best testing-track method (**0.6709**), while `FS-ConformalMondrian` is the strongest novel-track competitor after aggregate averaging (**0.6701**).
...
At the broader FewShot curve, **FS-Baseline-UniXcoder** reaches **0.7028** at **20%** train and **0.6844** at **10%**, giving the cleanest data-efficiency reference from the newly-unzipped JSONs. For the paper-facing low-budget **5%** slice, the top testing-track methods above paper UniXcoder full-data **0.6633** are **Hier-NTK (0.6709)**, **HierTree (0.6682)**, and **NTKAlign (0.6661)**; **Focal (0.6616)** is close but below the paper baseline. The strongest novel-track competitor after duplicate-aware aggregate averaging is **FS-ConformalMondrian (0.6701)**. Main method name in prose (testing claim): **Hier-NTK** (HierTree family prior + NTK alignment). Phase-transition: weak at **K=128**, unlocks between **~1%** and **~5%** data.
