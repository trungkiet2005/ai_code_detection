"""
Self-contained Kaggle runner: FS-Hier-NTK @ frac=0.20
Upload this single file to Kaggle and run:
  python exp_sc_hier_ntk_frac20.py
...
RAW_URL = "https://raw.githubusercontent.com/trungkiet2005/ai_code_detection/master/Exp_FewShot/testing/exp_fs_inline_hier_ntk.py"
