"""
Self-contained Kaggle runner: FS-Baseline-CE @ frac=0.10
Upload this single file to Kaggle and run:
  python exp_sc_baseline_ce_frac10.py
...
RAW_URL = "https://raw.githubusercontent.com/trungkiet2005/ai_code_detection/master/Exp_FewShot/testing/exp_fs_inline_baseline.py"
