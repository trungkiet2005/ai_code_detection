"""
exp_fs_inline_ntk_frozen.py -- ONE-FILE self-contained few-shot suite for Kaggle T4.

Method: FS-NTKAlign-Frozen (encoder frozen + NTK loss)
...
Output: /kaggle/working/results/exp_fs_inline_ntk_frozen_<label>_seed<S>.json
        (or ./results/... locally)
"""
...
logger = logging.getLogger('exp_fs_inline_ntk_frozen')
