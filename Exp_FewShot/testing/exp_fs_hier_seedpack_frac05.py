"""
exp_fs_inline_hier.py -- ONE-FILE self-contained inline for Kaggle T4.

Method: FS-HierTree (HierTree family prior (codellama+nxcode siblings); Exp_13's secret sauce in 20%-data climb)
...
Output: /kaggle/working/results/exp_fs_inline_hier_<label>_seed<S>.json
"""
...
logger = logging.getLogger('exp_fs_inline_hier')
...
METHODS = {
    ...
    'hier'          : ('FS-HierTree', 'exp_fs_inline_hier', 'hier', False),
