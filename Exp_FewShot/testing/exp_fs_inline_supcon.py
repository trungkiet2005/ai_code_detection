"""
exp_fs_inline_supcon.py -- ONE-FILE self-contained few-shot suite for Kaggle T4.

Method: FS-SupCon (CE + Supervised Contrastive (Khosla 2020))
...
Output: /kaggle/working/results/exp_fs_inline_supcon_<label>_seed<S>.json
        (or ./results/... locally)
"""
...
logger = logging.getLogger('exp_fs_inline_supcon')
