...
Single-method runner for CodeT5-Authorship style baseline.
...
METHOD = "codet5_authorship"
METHOD_NAME = "Published-CodeT5-Authorship"
EXP_PREFIX = "exp00_sota_codet5_authorship"


def main():
    encoders = _parse_csv_env("CODET5_ENCODERS", "codet5-base")
