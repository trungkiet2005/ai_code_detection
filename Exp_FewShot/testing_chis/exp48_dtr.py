...
# =============================================================================
# NEW MATHEMATICAL OBJECT: Decoupled Treatment Response (DTR)
# =============================================================================
"""
DTR models attribution as a heterogeneous treatment effect problem.

Each structural pattern T_k (e.g., nesting depth, loop patterns) is treated
as an "intervention" whose effect on authorship varies by generator.

Y = Σ_k τ_k(x) · T_k(x) + ε

where:
- T_k(x) = structural feature k for code x
- τ_k(x) = treatment effect of feature k (learned)
- Y = authorship prediction

Key insight: Some structural interventions have stronger attribution effects
than others. DTR learns which interventions matter.
"""
